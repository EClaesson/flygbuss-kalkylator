...
const AIRLINES: Airline[] = [
  {
    ...
    stops: [
      ...
      { name: "Sparre", before: 88, coord: [56.16018, 15.59148], price: 120, },
      { name: "Örlogshamnen", before: 84, coord: [56.1572, 15.58556], price: 120, },
      { name: "Amiralitetstorget", before: 83, coord: [56.15915, 15.58491], price: 120, },
      { name: "Varvet", before: 82, coord: [56.1593, 15.57979], price: 120, },
      {
      ...
      { name: "Kvarngatan", before: 76, coord: [56.1728, 15.59068], price: 120, },
      { name: "Galgamarkstrappan", before: 75, coord: [56.17759, 15.59491], price: 120, },
      { name: "Bergåsa Station", before: 73, coord: [56.1829, 15.6016], price: 120, },
